...
interface UserOption { id: number; name: string; title: string | null; department_name: string | null }
interface Props {
    units: Unit[];
    positions: Position[];
