...
export default function OfficerDashboard({ stats, upcoming }: Props) {
    ...
    return (
        <AppShell title="My Dashboard" appearance="flat">
            <div className="flat-dashboard officer-dashboard">
                ...
                <div className="officer-dashboard-metrics">
                    <StatGrid>
                ...
                <div className="card flat-dashboard-section officer-deadline-register">
