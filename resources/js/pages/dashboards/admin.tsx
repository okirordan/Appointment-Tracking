...
export default function AdminDashboard({ stats, recent_activity, departments }: Props) {
    return (
        <AppShell title="Admin Dashboard" appearance="flat">
            <div className="flat-dashboard admin-dashboard">
                <div className="page-hd flat-dashboard-heading">
                    <div>
                        <h1>Admin Dashboard</h1>
                        <div className="page-sub">System accounts, organizational structure and operational activity</div>
                    </div>
                </div>
                ...
                <div className="admin-dashboard-stack">
                    <div className="card flat-dashboard-section">
                    ...
                    <div className="card flat-dashboard-section admin-dashboard-list-card">
                        <div className="card-hd">
                            <div>
