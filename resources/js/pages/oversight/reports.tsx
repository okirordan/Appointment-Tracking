...
export default function Reports({
    ...
    return (
        <AppShell title="Reports & Performance" appearance="flat">
            <div className="government-flat report-flat-page">
                                    ...
                                    <Fragment key={department.name}>
                                        ...
                                        >
                                            <td>
                                                <button
                                                    type="button"
                                                    className="report-department-toggle"
                                                    aria-expanded={expanded === department.name}
                                                >
                                        ...
                                        {expanded === department.name &&
                                            department.officers.map((officer) => (
                                                <tr
                                                    className="report-officer-row"
                                                    key={`${department.name}-${officer.officer_id ?? officer.officer}`}
                                                >
                                                    <td>
                                                        {officer.officer_id === null ? (
                                                            ...
                                                            <Link
                                                                className="report-officer-link"
                                                                href={route('performance.show', officer.officer_id)}
                                                            >
